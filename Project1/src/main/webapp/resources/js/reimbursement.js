...
async function getReimbs(){
	let res = await fetch('http://localhost:8080/Project1/api/Reimbursement');
...
async function newReimb(e){
	...
	await fetch('http://localhost:8080/Project1/api/Reimbursement', {
		method: "POST",
		contentType: "application/json",
		body: JSON.stringify(reimb)
	});
	
	req = await fetch('http://localhost:8080/Project1/api/Reimbursement');
